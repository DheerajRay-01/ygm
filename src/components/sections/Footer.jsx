  ...
  <div className="relative mt-10 flex justify-center gap-6 text-2xl">
    {[FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn].map((Icon, idx) => (
      <a
        ...
        className="group relative text-[#A0A0A0] hover:text-[#FFD700] transition-colors duration-300 ease-in-out"> {/* color updated */}
        <Icon className="transition-transform duration-300 group-hover:scale-110" />
        <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#FFD700] transition-all duration-300 group-hover:w-full"></span> {/* color updated */}
      </a>
    ))}
  </div>
