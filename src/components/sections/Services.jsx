...
<div className="service-container w-full min-h-screen bg-gray-50 py-10 ">
  ...
  <div ref={serviceCardsRef} className="mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4">
